class eth_ref_model extends uvm_component;
  ...
  uvm_analysis_imp #(eth_sequence_item, eth_ref_model) seq_pkt_imp;
  uvm_analysis_port #(eth_sequence_item) exp_pkt_port;
  ...
  function void write(eth_sequence_item pkt);

  eth_sequence_item exp_pkt;
  byte unsigned data[$];
