...
// `include "eth_uvm/eth_interface.sv"
// `include "eth_uvm/eth_sequence_item.sv"
// `include "eth_uvm/eth_sequence.sv"
// `include "eth_uvm/eth_sequencer.sv"
// `include "eth_uvm/eth_driver.sv"
// `include "eth_uvm/eth_monitor.sv"
// `include "eth_uvm/eth_agent.sv"
// `include "eth_uvm/eth_scoreboard.sv"
// `include "eth_uvm/eth_environment.sv"
// `include "eth_uvm/eth_test.sv"
module eth_testbench;
  ...
  eth_top_synth tx_eth_top_synth (
    ...
    .phy_rx_clk  (intf.phy_rx_clk     ),  // RX clock input
    .phy_rxd     (intf.phy_rxd        ),  // RX data [3:0]
    .phy_rx_ctl  (intf.phy_rx_ctl     ),  // RX control (valid/error)
    ...
    .rx_axis_tready_i(intf.rx_axis_tready_i),   // RX ready

    // Configuration Register Interface (REG_BUS)
    .reg_bus_addr_i  (intf.reg_bus_addr_i ),   // Register address [3:0]
    .reg_bus_write_i (intf.reg_bus_write_i),  // Write enable
    .reg_bus_wdata_i (intf.reg_bus_wdata_i),  // Write data [31:0]
    .reg_bus_valid_i (intf.reg_bus_valid_i),  // Request valid
    .reg_bus_wstrb_i (intf.reg_bus_wstrb_i),  // Write strobe (byte enable)
    .reg_bus_rdata_o (intf.reg_bus_rdata_o),  // Read data [31:0]
    .reg_bus_ready_o (intf.reg_bus_ready_o),  // Response ready
    .reg_bus_error_o (intf.reg_bus_error_o)   // Error flag
  );
  
  initial begin
    uvm_config_db #(virtual eth_interface)::set(null, "*", "intf", intf );
  end
