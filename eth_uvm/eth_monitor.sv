class eth_monitor extends uvm_monitor;
  ...
  uvm_analysis_port #(eth_sequence_item) dut_pkt_port;  
  ...
  function new(string name = "eth_monitor", uvm_component parent);
  ...
  task run_phase (uvm_phase phase);
    ...
    forever begin
      ...
      if (tx_en && pkt == null) begin
        pkt = eth_sequence_item::type_id::create("pkt", this);
        pkt.data.delete();
